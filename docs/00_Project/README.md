...
- `VISION.md` — why Fandom Harbor exists, five-year direction and success
- `PRINCIPLES.md` — non-negotiable product/engineering rules
- `NON_GOALS.md` — intentionally refused scope
