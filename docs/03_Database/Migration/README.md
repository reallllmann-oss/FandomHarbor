...
| 20260819225318 | `admin_p1_identity_access_cutover.sql`    | Atomic legacy execute revoke, deny assertion and exact authenticated grant for the three ordinary-only v2 write RPCs                                   | Two clean rebuilds, 14 SQL suites, exact ACL matrix and local failure/rollback rehearsal     |
