...
| `admin_access_governance` | enabled           | Admin P1                                    | P1-00 scope frozen; implementation not started                                    |
| `web_admin_entry`         | disabled          | Independent post-pause release decision     | P1 must not expose an Admin link from Web                                         |
